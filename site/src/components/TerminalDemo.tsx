export default function TerminalDemo() {
  return (
    <section className="flex justify-center px-4 sm:px-6 -mt-8 sm:-mt-10 mb-14 sm:mb-20">
      <div className="w-full max-w-[700px] overflow-hidden rounded-xl border border-[#1e293b] bg-[#0d0d20] shadow-[0_20px_60px_rgba(0,0,0,0.5)]">
